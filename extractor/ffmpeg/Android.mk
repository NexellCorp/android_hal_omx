...
LOCAL_MODULE	:= libNX_FFMpegMKVExtractor
...
LOCAL_SRC_FILES :=			\
		FFmpegMatroskaExtractorExport.cpp \
		FFmpegExtractor.cpp	\
		ffmpeg_source.cpp	\
		ffmpeg_utils.cpp
...
endif	# ifeq ($(ANDROID_VERSION), 9)  #ffmpeg matroska extractor(pie)
